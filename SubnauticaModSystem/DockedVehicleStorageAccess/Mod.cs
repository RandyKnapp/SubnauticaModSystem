...
namespace DockedVehicleStorageAccess
{
	...
	static class Mod
	{
		public const string SaveDataFilename = "DockedVehicleStorageAccessSaveData.json";
		...
		public static void Save()
		{
			if (!IsSaving())
			{
				...
				var targets = GameObject.FindObjectsOfType<VehicleStorageAccess>();
				...
				saveObject = new GameObject("DockedVehicleStorageAccessSaveObject").AddComponent<ModSaver>();
